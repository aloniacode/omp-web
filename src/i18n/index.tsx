...
export const messages = {
  en: {
    ...
    "cmd.export": "Export transcript as HTML",
    "cmd.stop": "Stop the agent",
    "cmd.name": "Rename this conversation",
    ...
    "picker.browseDevice": "Browse device filesystem",
    "picker.browse": "Browse",
    "picker.up": "Parent folder",
    "picker.useFolder": "Choose this folder",
    "picker.emptyFolder": "No subfolders",
    "picker.fsError": "Cannot open this folder",
  ...
  zh: {
    ...
    "picker.browseDevice": "浏览设备文件系统",
    "picker.browse": "浏览",
    "picker.up": "上一级",
    "picker.useFolder": "选择此文件夹",
    "picker.emptyFolder": "没有子文件夹",
    "picker.fsError": "无法打开该文件夹",
