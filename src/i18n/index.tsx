...
export const messages = {
  en: {
    ...
    "message.error": "error",
    "composer.hint": "Messages sent while streaming are queued as follow-ups · tokens and cost update per turn",
    ...
    "settings.omp.queueing": "Queueing",
  ...
  zh: {
    ...
    "composer.hint": "输出期间发送的消息将作为追问排队 · token 与费用每回合更新",
    "message.sending": "发送中…",
    "message.failed": "失败",
